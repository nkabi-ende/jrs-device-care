  ...
  <section id="services" className="py-20 md:py-28 bg-background">
    <div className="container">
      ...
      >
        ...
        <h2 className="font-display text-3xl md:text-5xl font-bold mt-2 mb-4">Our Services</h2>
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-14">
        {services.map((s, i) => (
          ...
          >
            ...
            <Button asChild variant="ghost" size="sm" className="text-primary hover:text-primary font-semibold p-0 h-auto">
